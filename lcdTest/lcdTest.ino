<<<<<<< HEAD:lcdTest/lcdTest/lcdTest.ino
...
void home_screen()
  wait for input //pushbutton detection

  If (push_button_2 == true) //feed now
    {display measure_screen_1cup
    measure_screen function
      wait for input
      if pushbutton_1 //back
      ...
      if pushbutton_2 //minus
        ...
        if pushbuton_4 //plus
          display measure_screen_1cup
          loop back to measure_screen function //lan help
        if pushbutton_5//continue
          check_sensor();
          if 
      if pushbutton_3 //blank
...
>>>>>>> 06ec0380230daa368487009e558a09c10984a813:lcd.ino
