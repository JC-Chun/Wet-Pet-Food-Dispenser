...
class MockData {
    ...
    static func createMockMealListData(sectionTitle: String) -> [MealList] {
        ...
        if sectionTitle == "Upcoming" {
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: 0, hours: 0, mins: 1), portion: "2.5 cups"))
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: 1, hours: 0, mins: 30),  portion: "3 cups"))
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: 1, hours: 12, mins: 45), portion: "3.25 cups"))
...
//            mockMealList.append(MealList(dateAndTime: "Apr 14, 2020 6:45 pm", portion: "3.25 cups"))
            ...
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: -1, hours: 0, mins: 45), portion: "3.75 cups"))
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: -2, hours: 3, mins: 0), portion: "2.5 cups"))
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: -3, hours: 0, mins: 30), portion: "2.125 cups"))
            mockMealList.append(MealList(dateAndTime: Date().addDayAndTime(days: -5, hours: 2, mins: 15), portion: "5.23 cups"))
